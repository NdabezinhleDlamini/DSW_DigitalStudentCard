      ...
      <View style={styles.card}>
        <View style={styles.weatherWidget}>
          <View style={styles.weatherWidgetDetails}>
            <Text style={styles.weatherWidgetTitleText}>
              {weather.locationName ? weather.locationName : "Loading..."}
            </Text>
            <Text
              style={[
            ...
            <Text
              style={[styles.weatherWidgetText, { color: currentColors.text }]}
            >
              {weather.description}
            </Text>
          </View>
        ...
        <TouchableOpacity>
          <Image
            ...
            style={[styles.studentCard, { borderColor: currentColors.border }]}
          />
        </TouchableOpacity>
